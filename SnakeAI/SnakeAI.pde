...
void draw() {
  ...
  if(humanPlaying) {
    ...
    if(!modelLoaded) {
      ...
      textSize(15);
      textAlign(LEFT);
      text("GEN : "+pop.gen,100,60);
      text("BEST FITNESS : "+pop.bestFitness,100,120);
      text("MOVES LEFT : "+pop.bestSnake.lifeLeft,100,150);
      text("MUTATION RATE : "+mutationRate*100+"%",100,90);
